...
namespace sortcpp {
    namespace misc {
        ...
        // Cupcake Wrapper Sort
        template<class RandomAccessIterator, class Compare>
        void cupcake_wrapper_sort(RandomAccessIterator first, RandomAccessIterator last, Compare comp) {
            using sortcpp::_internal::pancake_sorting::cupcake_wrapper_sort;
            cupcake_wrapper_sort(first, last, comp);
        }

        template<class RandomAccessIterator>
        void cupcake_wrapper_sort(RandomAccessIterator first, RandomAccessIterator last) {
            cupcake_wrapper_sort(first, last, std::less<void>());
        }
    }
}