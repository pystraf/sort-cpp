...
namespace sortcpp {	
    namespace exchange {
        ...
        void dual_pivot_quick_sort(RandomAccessIterator first, RandomAccessIterator last, Compare comp) {
            using sortcpp::_internal::quick_sorting::dual_pivot_quick_sort;
            dual_pivot_quick_sort(first, last, comp);
        }
        ...
        void gnome_sort(RandomAccessIterator first, RandomAccessIterator last, Compare comp) {
            using sortcpp::_internal::gnome_sorting::gnome_sort;
        ...
        void index_quick_sort(RandomAccessIterator first, RandomAccessIterator last, Compare comp) {
            using sortcpp::_internal::index_quick_sorting::index_quick_sort;
            index_quick_sort(first, last, comp);
        }

        template<class RandomAccessIterator>
        void index_quick_sort(RandomAccessIterator first, RandomAccessIterator last) {
            index_quick_sort(first, last, std::less<void>());
        }
        ...
        void wiggle_sort(RandomAccessIterator first, RandomAccessIterator last, Compare comp) {
            using sortcpp::_internal::wiggle_sorting::wiggle_sort;
            wiggle_sort(first, last, comp);
        }
