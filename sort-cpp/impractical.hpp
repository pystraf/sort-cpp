...
namespace sortcpp {
    namespace impractical {
        ...
        void bubble_bogo_sort(RandomAccessIterator first, RandomAccessIterator last, RandomNumberGenerator &rng, Compare comp) {
            using sortcpp::_internal::bogo_sorting::bubble_bogo_sort;
            bubble_bogo_sort(first, last, rng, comp);
        }
        ...
        void exchange_bogo_sort(RandomAccessIterator first, RandomAccessIterator last, RandomNumberGenerator &rng, Compare comp) {
            using sortcpp::_internal::bogo_sorting::exchange_bogo_sort;
            exchange_bogo_sort(first, last, rng, comp);
        }
        ...
        void shove_sort(RandomAccessIterator first, RandomAccessIterator last, Compare comp) {
            using sortcpp::_internal::shove_sorting::shove_sort;
            shove_sort(first, last, comp);
        }
        ...
        void hanoi_sort(RandomAccessIterator first, RandomAccessIterator last, Compare comp) {
            ...
            hanoi_sort(first, last, false, comp);
        }
        ...
        // Stable Hanoi Sort
        template<class RandomAccessIterator, class Compare>
        void stable_hanoi_sort(RandomAccessIterator first, RandomAccessIterator last, Compare comp) {
            using sortcpp::_internal::hanoi_sorting::hanoi_sort;
            hanoi_sort(first, last, true, comp);
        }

        template<class RandomAccessIterator>
        void stable_hanoi_sort(RandomAccessIterator first, RandomAccessIterator last) {
            hanoi_sort(first, last, std::less<void>());
        }
        ...
        // Pancake Bogo Sort
        template<class RandomAccessIterator, class RandomNumberGenerator, class Compare>
        void pancake_bogo_sort(RandomAccessIterator first, RandomAccessIterator last, RandomNumberGenerator& rng, Compare comp) {
            using sortcpp::_internal::pancake_sorting::pancake_bogo_sort;
            pancake_bogo_sort(first, last, rng, comp);
        }

        template<class RandomAccessIterator, class RandomNumberGenerator>
        void pancake_bogo_sort(RandomAccessIterator first, RandomAccessIterator last, RandomNumberGenerator& rng) {
            pancake_bogo_sort(first, last, rng, std::less<void>());
        }
    }
}